...
import { VUEJS_SKILLS } from './VUEJS_SKILLS'

export const FRONTEND_SKILLS: ISkill = {  
  name: 'Frontend',
  since: 2020,
  level: 85,
  description: 'I have been working with React since 2021. Created multiple applications and websites. With a strong foundation in UI/UX design, I enjoy solving front-end challenges and creating exceptional user experiences.',
  subSkills: [
    REACT_SKILLS,
    TYPESCRIPT_SKILLS,
    JAVASCRIPT_SKILLS,
